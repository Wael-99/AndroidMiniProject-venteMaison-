...
import com.app.dabshi_test_graphic.Users.User;
...
public class SignupActivity extends AppCompatActivity {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        mDatabase.child(usertype)
                            ...
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(SignupActivity.this, "  Successfuly Signed ", Toast.LENGTH_LONG).show();
                                progressBar.setVisibility(View.GONE);
                                // Redirect to the user MainActivity ("check which user is signed in );
                                CheckUser();

                            } else {
                                Toast.makeText(SignupActivity.this, " Failed to add you  ", Toast.LENGTH_LONG).show();
                                progressBar.setVisibility(View.GONE);
                        ...
                        Toast.makeText(SignupActivity.this, " Email is Used before try another one! ", Toast.LENGTH_LONG).show();
                        progressBar.setVisibility(View.GONE);
                        signup.setEnabled(true);
                    }
                });
    ...
    private void CheckUser() {
        ...
        if (usertype.equals("Client")) {
            ...
            Intent i = new Intent(SignupActivity.this, ClientMainActivity.class);
            ...
            Intent i = new Intent(SignupActivity.this, OwnerMainActivity.class);
            i.addFlags(FLAG_ACTIVITY_NEW_TASK|FLAG_ACTIVITY_CLEAR_TASK);
            startActivity(i);
            finish();
